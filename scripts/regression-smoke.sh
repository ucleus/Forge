...
rg -n "function forge(StartNewPrompt|ShowLayoutGrid|OpenSettings)" assets/js/core.js >/dev/null
rg -n "forge(StartNewPrompt|ShowLayoutGrid|OpenSettings)" index.php midjourney.php >/dev/null
