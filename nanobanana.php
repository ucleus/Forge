...
<body>
<nav class="topnav">
  <div class="nav-brand"><div class="brand-dot">✦</div>FORGE</div>
  <div class="nav-tabs">
    ...
    <a class="nav-tab active" href="nanobanana.php" style="text-decoration:none">Nano Banana</a>
...
<div style="padding:0 20px 20px;color:var(--text-secondary)">Nano Banana builder module coming next.</div>
</body>
</html>
